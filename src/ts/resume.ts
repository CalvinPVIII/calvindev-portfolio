const resume = {
  workExperience: [
    ...
    },
    {
      ...
      description: [
        "Developed highly requested features such as chat widgets, enhanced notifications, and polished app navigation for a mobile gift card app.",
        "Addressed bug fixes and refined back-end systems through cross-functional team collaboration, resulting in improved app loading times and optimized communication between front-end and back-end processes.",
      ],
    },
  ],
  education: [
    {
      ...
      description: [
        "Completed a full-time 27 week program in web development with a perfect academic record.",
        "Developed over 60 projects utilizing JavaScript, Ruby, Rails, and React, all of which passed rigorous code reviews from instructors and peers, demonstrating a high level of proficiency and attention to detail.",
        "Enhanced teamwork and communication skills by leading pair programming sessions and group projects, resulting in improved project quality and higher peer evaluations.",
      ],
    },
  ],
};
